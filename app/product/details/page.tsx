...
const Details = () => {
    return (
        <div className='w-[727px] transition delay-150 duration-300 ease-in-out h-[300px] flex flex-col justify-between'>
            <div className="">

                <div className="text-B900 mb-[20px] text-normalSemiBold font-bold">Details</div>

                <div className="text-B500 text-regular">
            ...
            <ul className="text-B500 text-regular flex flex-col justify-between h-[110px] list-disc">
